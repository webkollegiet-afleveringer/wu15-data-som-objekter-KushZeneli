...
let footer = {
    brand: {
        ...
        copy: "Discover the equipped areas in Italy. Find the shop with all the services for you and your camper."
    },
    columns: [
        {
        ...
        },
        {
            ...
            links: ["Start your business", "Offer your service", "Are you a guide?"]
        },
        {
            headline: "Assistance",
